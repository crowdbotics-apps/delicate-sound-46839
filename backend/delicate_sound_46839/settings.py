"""
Django settings for delicate_sound_46839 project.
...
ROOT_URLCONF = 'delicate_sound_46839.urls'
...
WSGI_APPLICATION = 'delicate_sound_46839.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "delicate_sound_46839 API",
    "DESCRIPTION": "API documentation for delicate_sound_46839 App",
    "VERSION": "v1",
}
